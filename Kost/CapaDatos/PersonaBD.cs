...
#pragma warning restore CS0168 // La variable 'e' se ha declarado pero nunca se usa
        ...
        public static int Guardar(long pCuil, string pNombre, string pApellido, string pMail, DateTime pFechaNac, string pDireccion, string usuario, string contrasenia, int nivel, long cuilPersona, bool esUsuario)
        {
