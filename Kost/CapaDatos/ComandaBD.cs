...
#pragma warning restore CS0168 // La variable 'e' se ha declarado pero nunca se usa
        ...
        public static DataTable comandasActivas()
        {
            ...
            string sql = "SELECT CONCAT(P.nombre,' ', P.apellido)as nya, C.nroComanda,C.nroMesa FROM Personas P INNER JOIN Comandas C ON P.cuil = C.cuilMozo WHERE P.baja = 0 AND C.baja = 0 AND C.activa = 0";
